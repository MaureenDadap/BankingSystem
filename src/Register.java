...
public class Register {
    public static void regMethod(List<String> holdersList, List<Integer> holdersBalance, List<Date> dateList,
        ...
        while (true) {
            System.out.print("\n\tEnter the amount of initial deposit (min. Php 500): ");
            try {
        ...
        // creation to the Lists (our makeshift database)
        // stored in the main class
        holdersList.add(name);
        ageList.add(age);
        addressList.add(address);
        holdersBalance.add(initDeposit);
        dateList.add(new Date());
        mainClass.regCount++;

        // will store all records of transaction to our HashMap
        transactionString = formatter.format(new Date()) + " - Created a bank account";
        mainClass.putTransactions(mainClass.regCount, transactionString);
